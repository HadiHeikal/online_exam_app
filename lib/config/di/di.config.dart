...
import '../../features/auth/api/data_source_impl/local/auth_local_data_source_impl.dart'
    as _i424;
...
extension GetItInjectableX on _i174.GetIt {
  ...
  _i174.GetIt init({
    ...
    gh.lazySingleton<_i755.AuthLocalDataSource>(
      () => _i424.AuthLocalDataSourceImpl(
        flutterSecureStorage: gh<_i558.FlutterSecureStorage>(),
      ),
    );
    gh.lazySingleton<_i361.Dio>(
      () => dioModule.dio(gh<_i755.AuthLocalDataSource>()),
    );
